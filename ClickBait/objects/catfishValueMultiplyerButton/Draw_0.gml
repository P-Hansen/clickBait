...
width = x+375 + string_width(global.catfishMultiplyerCost)+10;
height = y + string_height(global.catfishMultiplyerCost)+10;
_x = x+375 - 10;
_y = y - 5;

if(disabled == false and fishObject.money >= global.catfishMultiplyerCost){
...
draw_text(x + 375, y, global.catfishMultiplyerCost);
