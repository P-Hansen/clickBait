...
width = x+375 + string_width(global.walleyeOddsCost)+10;
height = y + string_height(global.walleyeOddsCost)+10;
_x = x+375 - 10;
_y = y - 5;

if(disabled == false and fishObject.money >= global.walleyeOddsCost){
...
draw_text(x + 375, y, global.walleyeOddsCost);
