...
width = x+375 + string_width(global.troutValueCost)+10;
height = y + string_height(global.troutValueCost)+10;
_x = x+375 - 10;
_y = y - 5;

if(disabled == false and fishObject.money >= global.troutValueCost){
...
draw_text(x + 375, y, global.troutValueCost);
