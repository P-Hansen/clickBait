...
width = x+375 + string_width(global.salmonValueCost)+10;
height = y + string_height(global.salmonValueCost)+10;
_x = x+375 - 10;
_y = y - 5;

if(disabled == false and fishObject.money >= global.salmonValueCost){
...
draw_text(x + 375, y, global.salmonValueCost);
