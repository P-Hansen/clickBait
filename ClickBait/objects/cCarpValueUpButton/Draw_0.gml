...
width = x+375 + string_width(global.cCarpValueCost)+10;
height = y + string_height(global.cCarpValueCost)+10;
_x = x+375 - 10;
_y = y - 5;

if(disabled == false and fishObject.money >= global.cCarpValueCost){
...
draw_text(x + 375, y, global.cCarpValueCost);
